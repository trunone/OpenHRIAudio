...
/* Define to 1 if you have the `portmixer' library (-lportmixer). */
/* #undef HAVE_LIBPORTMIXER */
...
/* Name of package */
#define PACKAGE "openhriaudio"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "yosuke.matsusaka@aist.go.jp"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OpenHRIAudio"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OpenHRIAudio 2.01"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "openhriaudio"
